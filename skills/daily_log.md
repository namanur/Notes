# Daily Log Skill
**Purpose:** Create and maintain the daily runtime execution record of the vault.
**When to use:** At the start of every session or when a significant milestone is reached during the day.
**Steps:**
1. Navigate to `00_daily_logs/`.
2. Check if a log for today (`DD-MM-YYYY.md`) exists.
